 ...
 */
class Tx_Logging_Domain_Repository_EventRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{

    /**
     * @param Tx_Logging_Domain_Model_Dto_ReportsDemand $demand
     * @return array|Tx_Logging_Domain_Model_Event
     */
    public function findDemanded(Tx_Logging_Domain_Model_Dto_ReportsDemand $demand)
    {
        ...
        if ($demand->getAction()) {
            $constraints[] = $query->equals('action', $demand->getAction());
        }
    ...
    public function findBySession($sessionId)
    {
        ...
        $constraints = array();
        $constraints[] = $query->equals('session_id', $sessionId);
